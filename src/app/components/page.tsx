            ...
            <div className="mt-2 flex flex-wrap gap-1 px-2">
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map((tag, i) => (
                  <div
                    key={i}
                    className="rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 px-3 py-1 text-[10px] font-semibold"
                  >
                    {tag}
                  </div>
                ))}
                ...
                <div className="flex flex-row flex-wrap items-start gap-1">
                  {project.buttons.map((btn, i) => (
                    <a
                      ...
                      target="_blank"
                      href={btn.url}
                      className="items-center rounded-md border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground shadow hover:bg-primary/80 flex gap-2 px-2 py-1 text-[10px]"
                    >
                      {btn.label === "Website" && (
                        <svg
