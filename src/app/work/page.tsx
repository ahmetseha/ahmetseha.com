        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="space-y-2">
            <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Creating impactful applications that engage users and drive
              business value.
            </p>
          </div>
        </div>
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <article>
            ...
            <p className="text-sm text-muted-foreground font-sans mb-4">
              Developing <strong>e-commerce solutions</strong> for web and
              mobile platforms. Focus on{" "}
              <strong>scalable, user-friendly</strong> applications using
              cutting-edge technologies.
            </p>
            <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground font-sans">
              <li>
                <strong>Next.js</strong> & <strong>TypeScript</strong> for
